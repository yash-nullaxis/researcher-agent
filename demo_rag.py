...
import os
import shutil
from argus import Orchestrator, AgentConfig, ModelConfig, SqlAlchemyConnector, ChromaDBConnector
...
def setup_db():
    ...
    conn.execute("CREATE TABLE employees (id INT, name VARCHAR, salary INT, dept_id INT)")
...
async def main():
    ...
    if "RELEVANT TABLES" in summary:
        ...
        print("\nfail: RAG Filter not activated (maybe full summary returned or error).")
